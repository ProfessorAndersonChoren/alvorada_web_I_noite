...
document.getElementById("btnSum").addEventListener("click", () => {
    ...
    showMessage(`A soma do número ${numberOne} com o número ${numberTwo} é igual à ${sum}`)
})
...
document.getElementById("btnDiv").addEventListener("click", () => {
    ...
    showMessage(`A divisão do número ${numberOne} pelo número ${numberTwo} é igual à ${div}`)
})
